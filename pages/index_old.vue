      ...
      >
        <div class="w-full sm:w-6/12">
          ...
          <p class="text-xl mt-4 mb-14 text-skin-muted">
            <!-- RELAXSMP -->
            <span class="text-skin-base">RELAXSMP</span> is a Minecraft Server
          </p>
          <div class="space-x-4">
        ...
        <div class="w-full sm:w-6/12 flex justify-end p-6 sm:p-0">
          <img loading="lazy" src="~/assets/images/relaxsmpnewlogomenu6x.png" alt="" class="w-auto rounded-lg animate-pulse">
        </div>
      </div>
    </section>
